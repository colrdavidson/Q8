...
function getShader(id) {
    ...
    var src = "";
    var cur_child = shader_script.firstChild;

    while (cur_child) {
        if (cur_child.nodeType == cur_child.TEXT_NODE) {
            src += cur_child.textContent;
        }
...
function init_shader(v_shader, f_shader) {
    var vert_shader = getShader(v_shader);
    var frag_shader = getShader(f_shader);
