...
class VM {
	...
	if (table != undefined) {
	    ...
	    head_desc_cell.style = "flex-grow: 6";
	    head_id_cell.style = "text-align: center";
	    head_operand_cell.style = "text-align: center";
		...
		desc_cell.style = "flex-grow: 6";
		id_cell.style = "text-align: center";
		operand_cell.style = "text-align: center";
